...
mkdir -p %{buildroot}/%{_sysconfdir}/managesf
mkdir -p %{buildroot}/%{_var}/lib/managesf
mkdir -p %{buildroot}/%{_var}/log/managesf
mv %{buildroot}/usr/etc/managesf/sf-policy.yaml %{buildroot}/%{_sysconfdir}/managesf/sf-policy.yaml
...
%attr(-, managesf, managesf) %{_var}/lib/managesf
%attr(-, managesf, managesf) %{_var}/log/managesf

%changelog
* Tue Feb 24 2017 Fabien Boucher <fboucher@redhat.com> - 0.11.0-1
- Initial packaging
