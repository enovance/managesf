...
is useful for using tools like gertty (https://github.com/stackforge/gertty).
...
To provide private ssh keys to Gerrit's replication plugin. For a complete
example using GitHub, check the documentation on deploy_.
