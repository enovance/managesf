...
project and add a SSH-key based authentication for replication to GitHub::
 ...
 sfmanager --url <http://sfgateway.dom> \
     --auth user1:userpass \
     replication_config add --section testrepo url 'git@alias_gh_firstrepo:cschwede/${name}.git'
