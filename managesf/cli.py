...
def replication_command(parser):
    ...
    trigger = sub_cmd.add_parser('trigger',
                                 help='Trigger the testing events of a project')
    ...
    config_sub.add_parser('list', help='List of replication variables settings')
...
def project_user_action(args, base_url, headers):
    ...
    if subcommand in ['add_user', 'delete_user']:
        url = build_url(base_url, 'project', 'membership', args.name, args.user)
