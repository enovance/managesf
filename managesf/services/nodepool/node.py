...
class SFNodepoolSSHNodeManager(base.NodeManager):
    """Node management through Nodepool's CLI, called via SSH"""

    def __init__(self, plugin):
        super(SFNodepoolSSHNodeManager, self).__init__(plugin)
    ...
    def add_authorized_key(self, node_id, public_key, user=None):
        ...
        # TODO get a good regexp to validate public_key. Are " not allowed?
