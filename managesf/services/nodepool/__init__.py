...
class SoftwareFactoryNodepoolSSH(_Nodepool):
    ...
    def __init__(self, conf):
        super(SoftwareFactoryNodepoolSSH, self).__init__(conf)
        self.node = node.SFNodepoolSSHNodeManager(self)
        self.image = image.SFNodepoolSSHImageManager(self)
