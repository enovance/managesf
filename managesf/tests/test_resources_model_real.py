...
# TODO: will be deleted and replace by test_resources_engine_real.py
...
""",
    ...
    def test_project_resource(self):
        ...
        p = Project('id',
                    {'name': 'Nova',
                     'description': 'Hypervisor wrapper',
                     'website': 'http://nova.io',
                     'source-repositories': ['repo1', 'repo2'],
                     'mailing-lists': ['nova-project@mailing.com']})
        p.validate()
