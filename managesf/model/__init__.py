...
class User(Base):
    __tablename__ = 'users'
    username = Column(String(USERNAME_MAX_LEN), primary_key=True)
    fullname = Column(String(FULLNAME_MAX_LEN), nullable=False)
    email = Column(String(EMAIL_MAX_LEN), nullable=False)
    hashed_password = Column(String(HASHED_PASSWORD_MAX_LEN), nullable=False)
    sshkey = Column(String(SSHKEY_MAX_LEN), nullable=True)
