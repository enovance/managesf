...
# TODO(fbo): Add method to output the RST doc of reource models
# This will be added to the SF doc.
...
class BaseResource(object):
    ...
    def __init__(self, resource):
        ...
        self.id_validator = re.compile(self.__class__.BASE_MODEL['id'][1])
        assert "id" in resource
        assert isinstance(resource["id"], str)
        assert self.id_validator.match(resource["id"])
