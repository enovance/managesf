...
class Group(BaseResource):
    ...
    PRIORITY = 40
    CALLBACKS = {
        'update': lambda conf, new, kwargs: GroupOps(conf, new).update(**kwargs),
        'create': lambda conf, new, kwargs: GroupOps(conf, new).create(**kwargs),
        'delete': lambda conf, new, kwargs: GroupOps(conf, new).delete(**kwargs),
