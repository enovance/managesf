...
class AddUserForbidden(Exception): pass
class DeleteUserForbidden(Exception): pass
class UpdateUserForbidden(Exception): pass
class GetUserForbidden(Exception): pass
class UserNotFound(Exception): pass
class BadUserInfos(Exception): pass
class BindForbidden(Exception): pass
class InvalidInfosInput(Exception): pass
