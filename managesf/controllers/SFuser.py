...
class SFUserMapper:
    def set(self, sf_user_id, service, service_user_id):
        return crud.set_service_mapping(sf_user_id, service, service_user_id)

    def get_service_mapping(service, sf_user_id):
        return crud.get_service_mapping(service, sf_user_id)

    def get_user_mapping(service, service_user_id):
...
class SFUserManager:
    ...
    def create(self, username, email,
        ...
        logger.debug(msg % (username, email, fullname))
        ...
        if cauth_id and cauth_id > 0:
            ...
            if user:
                ...
                logger.debug(msg % (repr(user), cauth_id))
