...
class LocalUserController(RestController):
    ...
    def post(self, username):
        ...
        except localuser.AddUserForbidden:
            abort(403)
        except (localuser.InvalidInfosInput, localuser.BadUserInfos):
            abort(400)
        except Exception as e:
            return report_unhandled_error(e)
    ...
    def get(self, username):
        ...
        except localuser.GetUserForbidden:
            abort(403)
        except localuser.UserNotFound:
            abort(404)
        except Exception as e:
            return report_unhandled_error(e)
        return ret
    ...
    def delete(self, username):
        ...
        except localuser.DeleteUserForbidden:
            abort(403)
        except localuser.UserNotFound:
            abort(404)
        except Exception as e:
...
class LocalUserBindController(RestController):
    ...
    def get(self, username):
        ...
        if not authorization:
            abort(401)
        try:
            ret = localuser.bind_user(username, authorization)
        except (localuser.BindForbidden, localuser.UserNotFound):
            abort(401)
        except Exception as e:
            return report_unhandled_error(e)
        if not ret:
