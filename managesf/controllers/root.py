...
class ProjectController(RestController):
    ...
    def _reload_cache(self):
        """ Build the cache in 6 requests no matters the number
        of projects to display.
        """
        projects = {}
        ...
        # Get the list of project (1 request)
        ...
        # Consult requestor groups list and defined projects with admin rights
        # for the requestor
        for p in projects_list:
            # Verify that group is one of the requestor
        ...
        # Fill group details for project where user is admin
        for p in projects_list:
